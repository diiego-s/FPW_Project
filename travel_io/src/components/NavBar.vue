...
<template>
    <nav id="navbar">
            <ul>
                ...
                <li><RouterLink exact-active-class="active" to="/holidayPackage"><img class="icon" src="../assets/img/icon/globe.png" alt="icona holidayPackage">Pacchetti Viaggio</RouterLink></li>
